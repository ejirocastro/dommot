 ...
 * 
 * Interactive image carousel component for property listings featuring navigation controls,
 ...
 * - Dynamic badge display with color-coded property types
 ...
 * @property {Listing} listing - Complete listing object containing images and metadata
...
/**
 * ListingImage - Interactive property image carousel
 * 
 * Renders the main image display for property listings with navigation controls,
 * property badges, and interactive hover effects. Manages image transitions and
 * provides visual feedback for user interactions.
 * 
 * @param {ListingImageProps} props - Component props containing listing data and navigation handlers
