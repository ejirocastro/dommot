...
import { ArrowRight, Home, DollarSign, Users, Star, Shield } from 'lucide-react';
import { Logo } from '@/components/header/Logo';

export const StayHosting: React.FC = () => {
    const benefits = [
        {
            icon: DollarSign,
        ...
        },
        {
            icon: Shield,
            title: 'Safe & Secure',
            description: 'Host protection and verified guests'
        }
    ];
                        ...
                        <div className="space-y-8">
                            <div>
                                <div className="inline-flex items-center space-x-2 bg-sky-100 text-sky-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
                                    ...
                                    <span>Stay Hosting</span>
                                </div>
                                <h1 className="text-5xl font-bold text-gray-900 mb-6 leading-tight">
                                    Turn your space into 
                                    <span className="text-sky-600"> income</span>
                                </h1>
                                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                                    List your apartment, house, or room and start earning money by hosting travelers on DOMMOT.
                                </p>
                            </div>
            ...
            <div className="bg-white py-16">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Why host with DOMMOT?</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Join thousands of hosts who are earning extra income and meeting amazing people.
                        </p>
                    </div>
