...
import { ArrowRight, Users, DollarSign, Star, Shield } from 'lucide-react';
import { Logo } from '@/components/header/Logo';

export const ServicesHosting: React.FC = () => {
    const benefits = [
        {
            icon: DollarSign,
        ...
        },
        {
            ...
            description: 'Protected payments and verified clients'
        }
    ];

    const steps = [
        'Choose your service type',
        'Set your expertise and rates',
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                                    Offer professional services like personal chefs, massage therapy, makeup artistry, and more to travelers and locals.
                                </p>
                            </div>

                            <div className="flex items-center space-x-4">
                                <a
                                    href="/host/create-service"
            ...
            <div className="bg-white py-16">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Why offer services with DOMMOT?</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Turn your professional skills into a thriving business on our trusted platform.
                        </p>
                    </div>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600">
                            Start offering your professional services today.
                        </p>
                    </div>
