...
import {
  ...
  Eye, Heart, MapPin, Clock, Plus, ChevronRight,
  BarChart3, Edit, Camera, CheckCircle, AlertTriangle
} from 'lucide-react';

type DashboardMode = 'guest' | 'host';

export default function UnifiedDashboardPage() {
  const [mode, setMode] = useState<DashboardMode>('guest');
  ...
  const currentTabs = mode === 'guest' ? guestTabs : hostTabs;
  const currentStats = mode === 'guest' ? guestStats : hostStats;
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="relative p-2 text-gray-600 hover:text-gray-900">
                ...
                {currentStats.messagesUnread > 0 && (
                  <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
                    {currentStats.messagesUnread}
                  </span>
                )}
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {mode === 'guest'
              ...
              : "Manage your listings and track your hosting performance"
            }
          </p>
        </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{guestStats.totalBookings}</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">${guestStats.totalEarnings.toLocaleString()}</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{guestStats.averageRating}</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{guestStats.responseRate}%</p>
                </div>
            ...
            {currentTabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {tab.label}
                  {tab.id === 'messages' && currentStats.messagesUnread > 0 && (
        ...
        <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-gray-900">{guestStats.views}</p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-gray-900">{guestStats.favorites}</p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-gray-900">{guestStats.totalListings}</p>
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                  ...
                  <div className="p-6">
                    <div className="space-y-4">
                      {guestRecentBookings.map((booking) => (
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                  ...
                  <div className="p-6">
                    <div className="space-y-4">
                      {hostRecentBookings.map((booking) => (
          ...
          {/* Placeholder tabs for both modes */}
          {activeTab === 'bookings' && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h3 className="text-xl font-semibold mb-6">{mode === 'host' ? 'Booking Management' : 'All Bookings'}</h3>
          ...
          {activeTab === 'settings' && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h3 className="text-xl font-semibold mb-6">{mode === 'host' ? 'Host Settings' : 'Account Settings'}</h3>
              <div className="text-center py-12 text-gray-500">
