...
/**
 * Restaurants Experience Category Client Component
 *
 * Dedicated page showing all restaurant experiences.
...
export default function RestaurantsClient() {
    ...
    // Filter experiences for restaurants category
    const restaurantExperiences = useMemo(() => {
        return experiences.filter(exp => exp.category === 'Restaurants');
    }, []);

    // Sort experiences
    const sortedExperiences = useMemo(() => {
        const sorted = [...restaurantExperiences];
        switch (sortBy) {
            case 'price':
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <h1 className="text-lg font-semibold text-gray-900">Restaurant Experiences</h1>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900">Restaurant Experiences</h2>
