...
/**
 * Sports & Wellness Experience Category Page
 * 
 * Dedicated page for sports and wellness experiences in Lagos,
 * featuring fitness activities, wellness retreats, spa treatments, and active experiences.
 * Users can browse, filter, and book wellness experiences in this category.
 */
export default function SportsWellnessPage() {
    ...
    // Filter experiences for sports & wellness category
    const [wellnessExperiences, setWellnessExperiences] = useState<Experience[]>([]);

    useEffect(() => {
        const filtered = experiences.filter(exp => exp.category === 'Sports & Wellness');
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">
                                    {wellnessExperiences.length} wellness experiences • Fitness activities, spa treatments, and wellness retreats
                                </p>
                            </div>
                        </div>

                        {/* Category Description */}
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-teal-200/50 shadow-lg mb-6">
                            <p className="text-gray-700 leading-relaxed">
                                Rejuvenate your mind and body with our curated wellness and sports experiences. From luxury spa treatments
                                to active fitness sessions, discover the perfect balance for your well-being in Lagos.
                            </p>
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center py-16">
                            ...
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">
                                No wellness experiences found
                            </h2>
                            <p className="text-gray-600 max-w-md mx-auto">
                                We're working on adding more amazing wellness and sports experiences.
...
export const metadata = {
    title: 'Sports & Wellness Experiences | Dommot',
    description: 'Discover sports and wellness experiences in Lagos - fitness activities, spa treatments, and wellness retreats',
};
